...
#define ACCELEROMETER_FILTER_CUTOFF_FREQ_HZ 40
...
#define CONTROLLER_PID_KP 40.0f		// 40 – 55
#define CONTROLLER_PID_KI 0.0f		// 50 – 70
#define CONTROLLER_PID_KD 0.0f		// 50 – 70
#define CONTROLLER_MAX_INTEGRAL_LIMIT (CONTROLLER_PID_MAX_OUTPUT * 0.15f)
#define CONTROLLER_PID_KFF 0.0f		// 80

#define CONTROLLER_YAW_PID_KP 40.0f		// 40 – 50
#define CONTROLLER_YAW_PID_KI 0.0f		// 60 – 80
#define CONTROLLER_YAW_PID_KD 0.0f		// 0 – 15 (often near zero)
