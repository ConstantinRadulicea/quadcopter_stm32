...
#define CONTROLLER_PID_KP 0.6f		// 0.6
#define CONTROLLER_PID_KI 3.5f		// 3.5
#define CONTROLLER_PID_KD 0.0f		// 0.03
#define CONTROLLER_MAX_INTEGRAL_LIMIT ((CONTROLLER_PID_MAX_OUTPUT * 0.3) / CONTROLLER_PID_KI)
#define CONTROLLER_PID_KFF 0.0f		// 80

#define CONTROLLER_YAW_PID_KP 2.0f		// 2.0
#define CONTROLLER_YAW_PID_KI 12.0f		// 12.0
#define CONTROLLER_YAW_PID_KD 0.0f		// 0.0
#define CONTROLLER_YAW_MAX_INTEGRAL_LIMIT ((CONTROLLER_PID_MAX_OUTPUT * 0.3) / CONTROLLER_YAW_PID_KI)
