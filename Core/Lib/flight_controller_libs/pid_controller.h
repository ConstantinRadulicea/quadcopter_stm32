...
void pid_set_max_output(pid_controller_t *pid, float val);
void pid_set_min_output(pid_controller_t *pid, float val);
void pid_set_Kp(pid_controller_t *pid, float val);
void pid_set_Ki(pid_controller_t *pid, float val);
void pid_set_Kd(pid_controller_t *pid, float val);
void pid_set_integral_limit(pid_controller_t *pid, float val);
float pid_get_integral_limit(pid_controller_t *pid);
float pid_get_max_output(pid_controller_t *pid);
float pid_get_min_output(pid_controller_t *pid);
