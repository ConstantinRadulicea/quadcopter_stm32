...
C_SRCS += \
../Core/Lib/lwshell/tests/test.c 

C_DEPS += \
./Core/Lib/lwshell/tests/test.d 

OBJS += \
./Core/Lib/lwshell/tests/test.o 


# Each subdirectory must supply rules for building sources it contributes
Core/Lib/lwshell/tests/%.o Core/Lib/lwshell/tests/%.su Core/Lib/lwshell/tests/%.cyclo: ../Core/Lib/lwshell/tests/%.c Core/Lib/lwshell/tests/subdir.mk
...
clean: clean-Core-2f-Lib-2f-lwshell-2f-tests

clean-Core-2f-Lib-2f-lwshell-2f-tests:
	-$(RM) ./Core/Lib/lwshell/tests/test.cyclo ./Core/Lib/lwshell/tests/test.d ./Core/Lib/lwshell/tests/test.o ./Core/Lib/lwshell/tests/test.su

.PHONY: clean-Core-2f-Lib-2f-lwshell-2f-tests
