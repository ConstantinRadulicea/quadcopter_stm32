...
C_SRCS += \
../Core/Lib/lwshell/examples/example_minimal.c 

C_DEPS += \
./Core/Lib/lwshell/examples/example_minimal.d 

OBJS += \
./Core/Lib/lwshell/examples/example_minimal.o 


# Each subdirectory must supply rules for building sources it contributes
Core/Lib/lwshell/examples/%.o Core/Lib/lwshell/examples/%.su Core/Lib/lwshell/examples/%.cyclo: ../Core/Lib/lwshell/examples/%.c Core/Lib/lwshell/examples/subdir.mk
...
clean: clean-Core-2f-Lib-2f-lwshell-2f-examples

clean-Core-2f-Lib-2f-lwshell-2f-examples:
	-$(RM) ./Core/Lib/lwshell/examples/example_minimal.cyclo ./Core/Lib/lwshell/examples/example_minimal.d ./Core/Lib/lwshell/examples/example_minimal.o ./Core/Lib/lwshell/examples/example_minimal.su

.PHONY: clean-Core-2f-Lib-2f-lwshell-2f-examples
