...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/apps/httpserver/httpserver-netconn.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/apps/httpserver/httpserver-netconn.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/apps/httpserver/httpserver-netconn.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/apps/httpserver/%.o Middlewares/Third_Party/lwip/contrib/apps/httpserver/%.su Middlewares/Third_Party/lwip/contrib/apps/httpserver/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/apps/httpserver/%.c Middlewares/Third_Party/lwip/contrib/apps/httpserver/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-httpserver

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-httpserver:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/apps/httpserver/httpserver-netconn.cyclo ./Middlewares/Third_Party/lwip/contrib/apps/httpserver/httpserver-netconn.d ./Middlewares/Third_Party/lwip/contrib/apps/httpserver/httpserver-netconn.o ./Middlewares/Third_Party/lwip/contrib/apps/httpserver/httpserver-netconn.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-httpserver
