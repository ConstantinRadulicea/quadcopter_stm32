...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/apps/shell/shell.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/apps/shell/shell.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/apps/shell/shell.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/apps/shell/%.o Middlewares/Third_Party/lwip/contrib/apps/shell/%.su Middlewares/Third_Party/lwip/contrib/apps/shell/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/apps/shell/%.c Middlewares/Third_Party/lwip/contrib/apps/shell/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-shell

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-shell:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/apps/shell/shell.cyclo ./Middlewares/Third_Party/lwip/contrib/apps/shell/shell.d ./Middlewares/Third_Party/lwip/contrib/apps/shell/shell.o ./Middlewares/Third_Party/lwip/contrib/apps/shell/shell.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-shell
