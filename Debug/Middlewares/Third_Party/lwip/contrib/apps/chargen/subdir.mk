...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/apps/chargen/chargen.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/apps/chargen/chargen.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/apps/chargen/chargen.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/apps/chargen/%.o Middlewares/Third_Party/lwip/contrib/apps/chargen/%.su Middlewares/Third_Party/lwip/contrib/apps/chargen/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/apps/chargen/%.c Middlewares/Third_Party/lwip/contrib/apps/chargen/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-chargen

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-chargen:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/apps/chargen/chargen.cyclo ./Middlewares/Third_Party/lwip/contrib/apps/chargen/chargen.d ./Middlewares/Third_Party/lwip/contrib/apps/chargen/chargen.o ./Middlewares/Third_Party/lwip/contrib/apps/chargen/chargen.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-chargen
