...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/apps/ping/ping.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/apps/ping/ping.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/apps/ping/ping.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/apps/ping/%.o Middlewares/Third_Party/lwip/contrib/apps/ping/%.su Middlewares/Third_Party/lwip/contrib/apps/ping/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/apps/ping/%.c Middlewares/Third_Party/lwip/contrib/apps/ping/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-ping

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-ping:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/apps/ping/ping.cyclo ./Middlewares/Third_Party/lwip/contrib/apps/ping/ping.d ./Middlewares/Third_Party/lwip/contrib/apps/ping/ping.o ./Middlewares/Third_Party/lwip/contrib/apps/ping/ping.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-apps-2f-ping
