...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/tcp_isn.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/tcp_isn.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/tcp_isn.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/%.o Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/%.su Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/%.c Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-addons-2f-tcp_isn

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-addons-2f-tcp_isn:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/tcp_isn.cyclo ./Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/tcp_isn.d ./Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/tcp_isn.o ./Middlewares/Third_Party/lwip/contrib/addons/tcp_isn/tcp_isn.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-addons-2f-tcp_isn
