...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/examples/mdns/mdns_example.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/examples/mdns/mdns_example.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/examples/mdns/mdns_example.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/examples/mdns/%.o Middlewares/Third_Party/lwip/contrib/examples/mdns/%.su Middlewares/Third_Party/lwip/contrib/examples/mdns/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/examples/mdns/%.c Middlewares/Third_Party/lwip/contrib/examples/mdns/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-mdns

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-mdns:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/examples/mdns/mdns_example.cyclo ./Middlewares/Third_Party/lwip/contrib/examples/mdns/mdns_example.d ./Middlewares/Third_Party/lwip/contrib/examples/mdns/mdns_example.o ./Middlewares/Third_Party/lwip/contrib/examples/mdns/mdns_example.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-mdns
