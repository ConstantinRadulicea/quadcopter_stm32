...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/genfiles_example.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/genfiles_example.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/genfiles_example.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/%.o Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/%.su Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/%.c Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-httpd-2f-genfiles_example

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-httpd-2f-genfiles_example:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/genfiles_example.cyclo ./Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/genfiles_example.d ./Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/genfiles_example.o ./Middlewares/Third_Party/lwip/contrib/examples/httpd/genfiles_example/genfiles_example.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-httpd-2f-genfiles_example
