...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/examples/httpd/examples_fsdata.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/examples/httpd/examples_fsdata.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/examples/httpd/examples_fsdata.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/examples/httpd/%.o Middlewares/Third_Party/lwip/contrib/examples/httpd/%.su Middlewares/Third_Party/lwip/contrib/examples/httpd/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/examples/httpd/%.c Middlewares/Third_Party/lwip/contrib/examples/httpd/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-httpd

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-httpd:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/examples/httpd/examples_fsdata.cyclo ./Middlewares/Third_Party/lwip/contrib/examples/httpd/examples_fsdata.d ./Middlewares/Third_Party/lwip/contrib/examples/httpd/examples_fsdata.o ./Middlewares/Third_Party/lwip/contrib/examples/httpd/examples_fsdata.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-httpd
