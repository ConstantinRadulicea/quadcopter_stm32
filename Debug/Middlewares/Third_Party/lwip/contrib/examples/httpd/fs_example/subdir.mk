...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/fs_example.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/fs_example.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/fs_example.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/%.o Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/%.su Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/%.c Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-httpd-2f-fs_example

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-httpd-2f-fs_example:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/fs_example.cyclo ./Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/fs_example.d ./Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/fs_example.o ./Middlewares/Third_Party/lwip/contrib/examples/httpd/fs_example/fs_example.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-httpd-2f-fs_example
