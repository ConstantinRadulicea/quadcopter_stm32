...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/examples/snmp/snmp_example.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/examples/snmp/snmp_example.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/examples/snmp/snmp_example.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/examples/snmp/%.o Middlewares/Third_Party/lwip/contrib/examples/snmp/%.su Middlewares/Third_Party/lwip/contrib/examples/snmp/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/examples/snmp/%.c Middlewares/Third_Party/lwip/contrib/examples/snmp/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-snmp

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-snmp:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/examples/snmp/snmp_example.cyclo ./Middlewares/Third_Party/lwip/contrib/examples/snmp/snmp_example.d ./Middlewares/Third_Party/lwip/contrib/examples/snmp/snmp_example.o ./Middlewares/Third_Party/lwip/contrib/examples/snmp/snmp_example.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-snmp
