...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/examples/ethernetif/ethernetif.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/examples/ethernetif/ethernetif.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/examples/ethernetif/ethernetif.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/examples/ethernetif/%.o Middlewares/Third_Party/lwip/contrib/examples/ethernetif/%.su Middlewares/Third_Party/lwip/contrib/examples/ethernetif/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/examples/ethernetif/%.c Middlewares/Third_Party/lwip/contrib/examples/ethernetif/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-ethernetif

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-ethernetif:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/examples/ethernetif/ethernetif.cyclo ./Middlewares/Third_Party/lwip/contrib/examples/ethernetif/ethernetif.d ./Middlewares/Third_Party/lwip/contrib/examples/ethernetif/ethernetif.o ./Middlewares/Third_Party/lwip/contrib/examples/ethernetif/ethernetif.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-ethernetif
