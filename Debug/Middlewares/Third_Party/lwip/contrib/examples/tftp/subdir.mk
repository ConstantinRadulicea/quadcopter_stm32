...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/examples/tftp/tftp_example.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/examples/tftp/tftp_example.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/examples/tftp/tftp_example.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/examples/tftp/%.o Middlewares/Third_Party/lwip/contrib/examples/tftp/%.su Middlewares/Third_Party/lwip/contrib/examples/tftp/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/examples/tftp/%.c Middlewares/Third_Party/lwip/contrib/examples/tftp/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-tftp

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-tftp:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/examples/tftp/tftp_example.cyclo ./Middlewares/Third_Party/lwip/contrib/examples/tftp/tftp_example.d ./Middlewares/Third_Party/lwip/contrib/examples/tftp/tftp_example.o ./Middlewares/Third_Party/lwip/contrib/examples/tftp/tftp_example.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-tftp
