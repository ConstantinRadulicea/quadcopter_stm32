...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/examples/lwiperf/lwiperf_example.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/examples/lwiperf/lwiperf_example.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/examples/lwiperf/lwiperf_example.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/examples/lwiperf/%.o Middlewares/Third_Party/lwip/contrib/examples/lwiperf/%.su Middlewares/Third_Party/lwip/contrib/examples/lwiperf/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/examples/lwiperf/%.c Middlewares/Third_Party/lwip/contrib/examples/lwiperf/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-lwiperf

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-lwiperf:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/examples/lwiperf/lwiperf_example.cyclo ./Middlewares/Third_Party/lwip/contrib/examples/lwiperf/lwiperf_example.d ./Middlewares/Third_Party/lwip/contrib/examples/lwiperf/lwiperf_example.o ./Middlewares/Third_Party/lwip/contrib/examples/lwiperf/lwiperf_example.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-lwiperf
