...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/examples/ppp/pppos_example.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/examples/ppp/pppos_example.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/examples/ppp/pppos_example.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/examples/ppp/%.o Middlewares/Third_Party/lwip/contrib/examples/ppp/%.su Middlewares/Third_Party/lwip/contrib/examples/ppp/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/examples/ppp/%.c Middlewares/Third_Party/lwip/contrib/examples/ppp/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-ppp

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-ppp:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/examples/ppp/pppos_example.cyclo ./Middlewares/Third_Party/lwip/contrib/examples/ppp/pppos_example.d ./Middlewares/Third_Party/lwip/contrib/examples/ppp/pppos_example.o ./Middlewares/Third_Party/lwip/contrib/examples/ppp/pppos_example.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-ppp
