...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/examples/sntp/sntp_example.c 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/examples/sntp/sntp_example.d 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/examples/sntp/sntp_example.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/examples/sntp/%.o Middlewares/Third_Party/lwip/contrib/examples/sntp/%.su Middlewares/Third_Party/lwip/contrib/examples/sntp/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/examples/sntp/%.c Middlewares/Third_Party/lwip/contrib/examples/sntp/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-sntp

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-sntp:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/examples/sntp/sntp_example.cyclo ./Middlewares/Third_Party/lwip/contrib/examples/sntp/sntp_example.d ./Middlewares/Third_Party/lwip/contrib/examples/sntp/sntp_example.o ./Middlewares/Third_Party/lwip/contrib/examples/sntp/sntp_example.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-examples-2f-sntp
